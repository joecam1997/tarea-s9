class Lista_1:
    ...
    def eliminar2 (self,dato):
        poseliminado=0
        ind=0
        while ind < len(self.lista):
            if self.lista[ind]==dato:
                poseliminado=ind
                break
            ind+=1
        if poseliminado>=0:
            self.lista=self.lista[:poseliminado]+self.lista[poseliminado+1:]
            self.longitud-=1
        return poseliminado
...
# lista1.insertar(0)
print(lista1.eliminar2(5))
print(lista1.eliminar2(23))