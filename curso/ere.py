...
[documentos]class OrderedClassMembers(type):
...
[documentos]class TSP(metaclass=OrderedClassMembers):
...
[documentos]	def ini_tsp(self, n_ciudades: int, size_space: int, dimension: int, _) -> List[Tuple[int, int]]:
		"""
...
[documentos]	def calcular_fitness(self, recorrido: List[Tuple[int, int]], _) -> float:
		"""
...
[documentos]	def imprimir_respuesta(self, problema_base: List[Tuple[int, int]], bestfitnes: object, cola: None = None) -> None:
		"""
...
[documentos]	@lru_cache(maxsize=None)
